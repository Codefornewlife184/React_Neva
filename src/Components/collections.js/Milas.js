...
const [mainImage, setMainImage] = useState('assets/images/products/1702.png');
const [showModal, setShowModal] = useState(false);
const [currentImageIndex, setCurrentImageIndex] = useState(0);

const productImages = [
'assets/images/products/1700.png',
'assets/images/products/1701.png',
'assets/images/products/1702.png',
'assets/images/products/1701.png',
'assets/images/products/1702.png'
];
  ...
  <>
        ...
        <div className="row">
          <div className="col-lg-12 col-xl-6">
            ...
            <div className="product-thumbnails" style={{ 
              ...
              <img key={index} src={image} alt={`Milas Koleksiyonu ${index + 1}`} style={{
                      ...
                      objectFit: 'cover',
                      cursor: 'pointer',
                      border: mainImage === image ? '2px solid #10adad' : 'none',
          ...
          <div className="col-lg-12 col-xl-6">
            ...
            <div className="product-details__content">
              <p>
                Milas koleksiyonu, modern tasarım anlayışıyla üretilen, konfor ve şıklığı bir arada sunan özel bir
                seridir.
              ...
              <p className="product-description__text">
                ...
                zarafet katacak. Geniş renk ve kumaş seçenekleriyle kişisel zevkinize uygun kombinasyonlar
                oluşturabilirsiniz.
              </p><br/>
              <p>
                REF: MIL-2024 <br />
    ...
    <div style={{
      ...
      <div style={{ 
        ...
        <img src={productImages[currentImageIndex]} alt="Büyük görüntü" style={{
                maxWidth: '100%',
                maxHeight: '90vh',
                objectFit: 'contain'
              }} />
