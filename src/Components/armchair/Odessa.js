          ...
          <div className="col-lg-12 col-xl-6">
            <div className="product-details__top">
              <h3 className="product-details__title">
                Odessa Koltuk Takımı
              </h3>
              <p className="product-details__price">Özel Fiyat</p>
            </div>
            <div className="product-details__content">
              <p>
                <strong style={{color:'#000'}}>Doğanın ilham veren renkleriyle buluşan modern zarafet: ODESSA Koltuk
                  Takımı.</strong>
                <br />Yumuşak hatlara sahip tasarımı, pastel yeşil ve krem tonlarının uyumuyla huzur dolu bir yaşam
                alanı sunar.</p>
              <p className="product-description__text">
                Minimalist çizgileri ve estetik detaylarıyla öne çıkan ODESSA, sade ama şık dekorasyon anlayışını
                benimseyenler için ideal bir seçenektir. Ahşap ayak yapısı, doğal dokuyu modern mobilya tasarımıyla bir
                araya getirir.
              </p>
              <p>
                → Yumuşak dokulu konforlu oturum alanları
                <br />
                → Kadifemsi dokuya sahip rahat oturum alanları
                <br />
                → Pastel tonlarda modern renk uyumu
                <br />
                → Minimal çizgilerle zarif tasarım
                <br />
                → Kolay temizlik imkânı sunan yüksek ayaklar
                <br />
                <strong style={{color:'#000'}}>ODESSA Koltuk Takımı,</strong> evinize ferahlık ve doğallık katmak için
                tasarlandı. Sade şıklığın peşindeyseniz, bu koleksiyon tam size göre!
              </p>
            </div>
