          ...
          <div className="row">
            <div className="col-lg-12 col-xl-6">
              <div className="product-details__image">
                <img src={mainImage} alt={t("brahma.title")}
                  style={{
                    width: '100%',
                    height: 'auto',
                    cursor: 'pointer',
              ...
              <div className="product-thumbnails" style={{
                ...
                {productImages.map((image, index) => (
                  <img key={index} src={image} alt={`${t("brahma.title")} ${index + 1}`} style={{
                    width: '80px',
                    height: '80px',
                    objectFit: 'cover',
                    cursor: 'pointer',
            ...
            <div className="col-lg-12 col-xl-6">
              <div className="product-details__top">
                ...
                <p className="product-details__price">{t("brahma.price")}</p>
              </div>
              <div className="product-details__content">
                <p>
                  <strong style={{ color: '#000' }}>{t("brahma.description")}</strong>
                </p>
                ...
                <ul>
                  <li>→ {t("brahma.natural")}</li>
                  <li>→ {t("brahma.ergonomic")}</li>
                  <li>→ {t("brahma.handmade")}</li>
                  <li>→ {t("brahma.durability")}</li>
                  <li>→ {t("brahma.production")}</li>
                </ul>
                <p>
                  <strong style={{ color: '#000' }}>{t("brahma.company")}</strong>
                </p>
              </div>
              <div className="product-details__buttons">
                <a className="theme-btn btn-style-one" href="/contact">
                  <i className="btn-curve"></i>
                  <span className="btn-title">{t("brahma.contact")}</span>
                </a>
              </div>
            </div>
          </div>
          ...
          return (
            <div style={{
              ...
              <div style={{
                ...
                <img src={process.env.PUBLIC_URL + '/' + productImages[currentImageIndex]} alt={t("brahma.title")} style={{
                  maxWidth: '100%',
                  maxHeight: isMobile ? '80vh' : '90vh',
                  objectFit: 'contain',
                  display: 'block'
