...
const [mainImage, setMainImage] = useState('assets/images/products/berjer/boss-berjer-1.webp');
const [showModal, setShowModal] = useState(false);
const [currentImageIndex, setCurrentImageIndex] = useState(0);

const productImages = [
'assets/images/products/berjer/boss-berjer-1.webp',
'assets/images/products/berjer/boss-berjer-2.webp'
];
